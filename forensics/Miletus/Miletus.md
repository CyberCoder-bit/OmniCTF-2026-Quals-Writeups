...
### Deobfuscation
This is some obfuscated code. Step 1 is to deobfuscate it. I wrote [solve.py](solve.py) and a helper file named [ps_deobf.py](ps_deobf.py) to deobfuscate the code.
